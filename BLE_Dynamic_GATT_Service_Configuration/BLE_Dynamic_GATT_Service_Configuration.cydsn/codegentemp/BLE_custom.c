...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* Crypto service */
    {
        0x000Cu, /* Handle of the Crypto service */ 
        {

            /* Public key control characteristic */
            {
                0x000Eu, /* Handle of the Public key control characteristic */ 
            ...
            /* Encrypted Data control characteristic */
            {
                0x0011u, /* Handle of the Encrypted Data control characteristic */ 
            ...
            /* key signature control characteristic */
            {
                0x0014u, /* Handle of the key signature control characteristic */ 
