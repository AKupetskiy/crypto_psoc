...
#define CYBLE_CRYPTO_SERVICE_INDEX   (0x00u) /* Index of Crypto service in the cyBle_customs array */
#define CYBLE_CRYPTO_PUBLIC_KEY_CONTROL_CHAR_INDEX   (0x00u) /* Index of Public key control characteristic */
#define CYBLE_CRYPTO_PUBLIC_KEY_CONTROL_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
#define CYBLE_CRYPTO_ENCRYPTED_DATA_CONTROL_CHAR_INDEX   (0x01u) /* Index of Encrypted Data control characteristic */
#define CYBLE_CRYPTO_ENCRYPTED_DATA_CONTROL_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
#define CYBLE_CRYPTO_KEY_SIGNATURE_CONTROL_CHAR_INDEX   (0x02u) /* Index of key signature control characteristic */
#define CYBLE_CRYPTO_KEY_SIGNATURE_CONTROL_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */


#define CYBLE_CRYPTO_SERVICE_HANDLE   (0x000Cu) /* Handle of Crypto service */
#define CYBLE_CRYPTO_PUBLIC_KEY_CONTROL_DECL_HANDLE   (0x000Du) /* Handle of Public key control characteristic declaration */
#define CYBLE_CRYPTO_PUBLIC_KEY_CONTROL_CHAR_HANDLE   (0x000Eu) /* Handle of Public key control characteristic */
#define CYBLE_CRYPTO_PUBLIC_KEY_CONTROL_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x000Fu) /* Handle of Client Characteristic Configuration descriptor */
#define CYBLE_CRYPTO_ENCRYPTED_DATA_CONTROL_DECL_HANDLE   (0x0010u) /* Handle of Encrypted Data control characteristic declaration */
#define CYBLE_CRYPTO_ENCRYPTED_DATA_CONTROL_CHAR_HANDLE   (0x0011u) /* Handle of Encrypted Data control characteristic */
#define CYBLE_CRYPTO_ENCRYPTED_DATA_CONTROL_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0012u) /* Handle of Client Characteristic Configuration descriptor */
#define CYBLE_CRYPTO_KEY_SIGNATURE_CONTROL_DECL_HANDLE   (0x0013u) /* Handle of key signature control characteristic declaration */
#define CYBLE_CRYPTO_KEY_SIGNATURE_CONTROL_CHAR_HANDLE   (0x0014u) /* Handle of key signature control characteristic */
#define CYBLE_CRYPTO_KEY_SIGNATURE_CONTROL_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0015u) /* Handle of Client Characteristic Configuration descriptor */
